...
#include "Natives\NativeEnums.h"
#include "Natives\NativeStructs.h"
...
extern "C" NTKERNELAPI BOOLEAN ExEnumHandleTable
(
    IN PHANDLE_TABLE HandleTable,
...
extern "C" NTKERNELAPI VOID FASTCALL ExfUnblockPushLock
(
